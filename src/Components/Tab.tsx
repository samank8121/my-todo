            ...
            <div className="font-sans">
                ...
                <div className="relative">
                            ...
                            <div className="w-full mb-0">
                                ...
                                <div className="relative flex flex-col w-full min-w-0 mb-6 break-words bg-white border-t-2 border-tab-border">
                                    <div className="flex-auto px-4 py-5">
                                         ...
                                         */}
                                        <TodoList data={todos} isDone={openTab === 2} editTodo={editTodoModal} deleteTodo={deleteTodo}
                                            doneTodo={doneTodo} />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="absolute top-3 right-5">
                        <button onClick={addClicked} className="inline-flex px-4 py-2 font-bold text-white rounded ml bg-button-blue focus:outline-none hover:bg-grey">
